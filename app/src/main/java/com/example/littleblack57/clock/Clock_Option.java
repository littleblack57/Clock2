...
public class Clock_Option extends AppCompatActivity {
    ...
    private TextView m_tv_option_content2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (clockOptionSelectAdapter.getButtonVisibilty()) {

            m_btn_option_delete.setVisibility(View.VISIBLE);

        } else {

            m_btn_option_delete.setVisibility(View.GONE);
        ...
        m_ClockOptionAdapter.setOnClockOptionRecyclerViewItemClickListener(new ClockOptionRecyclerViewAdapter.OnClockOptionRecyclerViewItemClickListener() {
            ...
            public void OnClick(View view, int position) {
                ...
                switch (position) {
                    ...
                    case 2:
                        setRingtone(view);
                        m_tv_option_content2 = (TextView)view.findViewById(R.id.tv_option_content);
                        break;
                    case 3:
    ...
    public void showTimePickerDialog(View view) {
        ...
        m_hour = clockOptionSelectAdapter.getHour();
        m_minute = clockOptionSelectAdapter.getMinute();
...
//    public void chooseRingtoneDialog(final View view){
//
//        new AlertDialog.Builder(this,android.R.style.Theme_Holo_Light_Dialog_NoActionBar)
//                .setTitle("鈴聲")
...
//    }
    ...
    public void setRingtone(final View view) {
        ...
        startActivityForResult(intent, Ringtone_SELECT);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == Ringtone_SELECT) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (uri != null) {
                    ...
                    String ringtonetitle = ringtone.getTitle(getApplicationContext());
                    clockOptionSelectAdapter.setRingtoneUriString(uri.toString());
                    clockOptionSelectAdapter.setRingtoneTitle(ringtonetitle);
                    m_tv_option_content2.setVisibility(View.VISIBLE);
                    m_tv_option_content2.setText(ringtonetitle);
